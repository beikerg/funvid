  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
       ...
       <form action="ajax/terapias/grupo-atras/addGa.php?id=<?php echo $id_residente; ?>" method="POST">
      
       <?php include("ajax/terapias/grupo-atras/tableTResidente.php"); ?>
            ...
            <div class="box-body">
              ...
              <div class="containe">
                     ...
                     <div class="row">
                      <div class="form-group col-md-4">
                         <label>Nombre Lider:</label>
                          <input class="form-control" type="text" name="lider_ga" id="lider_ga" placeholder="Nombre">
                      </div> 

                      <div class="form-group col-md-4">                          
                              <label>Nombre Colider:</label>
                              <input class="form-control" type="text" name="colider_ga" id="colider_ga" placeholder="Nombre Colider">                          
                      </div>
                      
                      <div class="form-group col-md-4">                          
                              <label>Solicitante:</label>
                              <input class="form-control" type="text" name="solicita_ga" id="solicita_ga" placeholder="¿Quién solicita la terapia?">                          
                      </div>
                     </div> 
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="date" name="fecha_ga" class="form-control pull-right" value="<?php echo date("Y-m-d"); ?>">
                </div>
                <!-- /.input group -->
              </div>
                      ...
                      <div class="form-group col-md-4">
                          ...
                          <input class="form-control" name="h_inicio_ga" type="time" value="<?php echo date("H:i"); ?>">
                      </div>
                      
                      <div class="form-group col-md-4">
                          <label>Hora termino:</label>
                          <input class="form-control" name="h_fin_ga" type="time">
                      </div>
              ...
              <div class="box-body">
                ...
                <div class="containe">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="o_lider_ga" placeholder="Observaciones ..."></textarea>
                  </div>
                    
                  <div class="form-group">
                    <label>Observaciones Colider</label>
                    <textarea class="form-control" rows="3" name="o_colider_ga" placeholder="Observaciones ..."></textarea>
                  </div>
                     
                  <div class="form-group">
                    <label>Observaciones del solicitante</label>
                    <textarea class="form-control" rows="3" name="o_solicita_ga" placeholder="Observaciones del residente que solicito la terapia ..."></textarea>
                  </div>
              ...
              <div class="box-body">
                ...
                <div class="containe">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="actitud_ga" placeholder="Actitud asumida ..."></textarea>
                  </div>
