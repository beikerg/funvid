  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
       ...
       <form action="ajax/terapias/especial/addEspecial.php?id=<?php echo $id_residente; ?>" method="POST">
                ...
                <input type="hidden" name="id_residente" value="<?php echo $id_residente; ?>" >
                    <div class="row">
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <select class="form-control" name="etapa_te" id="etapa_te">
            ...
            <div class="box-body">
              ...
              <div class="containe">
                     ...
                     <div class="row">
                      <div class="form-group col-md-4">
                         <label>Nombre Lider:</label>
                          <input class="form-control" type="text" name="lider_te" id="lider_te" placeholder="Nombre">
                      </div> 

                      <div class="form-group col-md-4">                          
                              <label>Nombre Colider:</label>
                              <input class="form-control" type="text" name="colider_te" id="colider_te" placeholder="Nombre Colider">                          
                      </div>
                      
                      <div class="form-group col-md-4">                          
                              <label>Solicitante:</label>
                              <input class="form-control" type="text" name="solicita_te" id="solicita_te" placeholder="¿Quién solicita la terapia?">                          
                      </div>
                     </div> 
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="date" name="fecha_te" class="form-control pull-right" value="<?php echo date("Y-m-d"); ?>">
                </div>
                <!-- /.input group -->
              </div>
                      ...
                      <div class="form-group col-md-4">
                          ...
                          <input class="form-control" name="h_inicio_te" type="time" value="<?php echo date("H:i"); ?>">
                      </div>
                      
                      <div class="form-group col-md-4">
                          <label>Hora termino:</label>
                          <input class="form-control" name="h_fin_te" type="time">
                      </div>
          ...
          <div class="box-body">
            ...
            <div class="col-sm-3">
              <div class="box-body">
               ...
               <div class="form-check">
                <label>
                  <input type="checkbox" name="falla[]" value="POCO TEMPLE" class="flat-red">
                  POCO TEMPLE
                </label>
              </div>
               ...
               <div class="form-check">
                <label>
                  <input type="checkbox" name="falla[]" value="POCO HUMILDE" class="flat-red">
                  POCO HUMILDE
                </label>
              </div>
              ...
              <div class="box-body">
                ...
                <div class="containe">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="o_lider_te" placeholder="Observaciones ..."></textarea>
                  </div>
                    
                  <div class="form-group">
                    <label>Observaciones Colider</label>
                    <textarea class="form-control" rows="3" name="o_colider_te" placeholder="Observaciones ..."></textarea>
                  </div>
                     
                  <div class="form-group">
                    <label>Observaciones del solicitante</label>
                    <textarea class="form-control" rows="3" name="o_solicita_te" placeholder="Observaciones del residente que solicito la terapia ..."></textarea>
                  </div>
              ...
              <div class="box-body">
                ...
                <div class="containe">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="actitud_te" placeholder="Actitud asumida ..."></textarea>
                  </div>
