...
<div class="row">
  <div class=" pull-right col-md-3 col-offset-9">
    <div class="pull-right">
      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#newIntro"><i class="fa fa-plus"></i> Nueva introvisación</button><br>
    </div>
  </div>
</div><br>
...
<div id="newIntro" tabindex="-1" class="modal fade" role="dialog" >
    ...
    if(mysqli_num_rows($result) > 0)
    {
        ...
        while($row = mysqli_fetch_assoc($result))
        {
            ...
            <tr>
                ...
                <th>'.$row['rut'].'</th>
                <th> <center>         
                    <center><a href="introvisacion.php?id='.$row['id_residente'].'"class="btn btn-primary"><i class="glyphicon glyphicon-check"></i></a></center> </center> ';
                }
