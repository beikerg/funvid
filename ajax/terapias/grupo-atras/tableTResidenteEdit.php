  ...
  <div class="col-md-12">
    ...
    <div class="nav-tabs-custom">
      ...
      <div class="tab-content">
                            ...
                            <tbody>
                              <?php
                                ...
                                if($c_sql == 0){
                                  ...
                                  $sql = "SELECT r.nombre, r.apellido, r.rut, a.* FROM residentes r INNER JOIN asistencia a ON r.id_residente = a.id_residente WHERE a.id_ga = '$id_ga'";
                                }
        ...
        <?php 
          include('ajax/db_connection.php');
            $q = $mysql->query("SELECT r.nombre, r.apellido, a.* FROM residentes r INNER JOIN asistencia a ON r.id_residente = a.id_residente WHERE a.id_ga = '$id_ga' AND a.status_asis = '0'");
