  ...
  <div class="col-md-12">
    ...
    <div class="nav-tabs-custom">
      ...
      <div class="tab-content">
                            ...
                            <tbody>
                              <?php
                                ...
                                if($c_sql == 0){
                                  ...
                                  $sql = "SELECT r.nombre, r.apellido, r.rut, a.* FROM residentes r INNER JOIN asistencia a ON r.id_residente = a.id_residente WHERE a.id_t_pase = '$id_t_pase'";
                                }
        ...
        <?php 
          include('ajax/db_connection.php');
            $q = $mysql->query("SELECT r.nombre, r.apellido, a.* FROM residentes r INNER JOIN asistencia a ON r.id_residente = a.id_residente WHERE a.id_t_pase = '$id_t_pase' AND a.status_asis = '0'");
...
<!-- END CUSTOM TABS -->
                  ...
                  <div class="modal-footer">
                    <input type="hidden" name="id_t_pase" value="<?php echo $id_t_pase;?>">
