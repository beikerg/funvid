  ...
  <div class="col-md-12">
    ...
    <div class="nav-tabs-custom">
      ...
      <div class="tab-content">
                          ...
                          <thead>
                            ...
                            <tbody>
                              <?php
                                ...
                                if($c_sql == 0){
                                  $sql = "SELECT * FROM residentes WHERE etapa_resi = 'EDUCADOR-1' || etapa_resi = 'EDUCADOR-2' || etapa_resi = 'EDUCADOR-3' || etapa_resi = 'EDUCADOR-4' || etapa_resi = 'TRASCENDENCIA' || etapa_resi = 'IDENTIDAD'";
                                }else{
                                  $sql = "SELECT r.nombre, r.apellido, r.rut, a.* FROM residentes r INNER JOIN asistencia a ON r.id_residente = a.id_residente WHERE a.id_avanzada = '$id_avanzada'";
                                }
        ...
        <?php 
          include('ajax/db_connection.php');
            $q = $mysql->query("SELECT r.nombre, r.apellido, a.* FROM residentes r INNER JOIN asistencia a ON r.id_residente = a.id_residente WHERE a.id_avanzada = '$id_avanzada' AND a.status_asis = '0'");
