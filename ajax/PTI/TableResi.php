...
</div><br>  SE PASO A HISTORICORESI.PHP-->
        ...
        <table id="" class="display table table-bordered table-striped dt-responsive nowrap">
          ...
          <tbody>
            ...
            $data = "";
             ...
             $query = "SELECT * FROM residentes WHERE etapa_resi <> 'ABANDONO' AND etapa_resi <> 'REDUCADO' ";
    ...
    if(mysqli_num_rows($result) > 0)
    {
        ...
        while($row = mysqli_fetch_assoc($result))
        {
            ...
            <tr>
                ...
                <th>'.$row['rut'].'</th>
                <th> <center>         
                    <center><a href="PTI.php?id='.$row['id_residente'].'"class="btn btn-primary"><i class="glyphicon glyphicon-check"></i></a></center> </center> ';
                }
