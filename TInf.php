              ...
              <!-- // INICIO DEL BODY DEL BOX //-->                            
                    ...
                    <div class="row">                      
                      <div class="form-group col-md-4">
                        ...
                        <input type="date" value="<?php echo date("Y-m-d"); ?>" name="fecha_ti" class="form-control pull-right" >
                      </div>
                      <!-- /.input group -->
                    </div>                     
                      <div class="form-group col-md-4">
                          <label>Hora inicio:</label><br>
                          <input class="form-control" type="time" name="h_inicio_ti" value="<?php echo date("H:i"); ?>">
                      </div>
                      
                      <div class="form-group col-md-4">
                          <label>Hora termino:</label><br>
                          <input class="form-control" type="time" name="h_fin_ti" value="<?php date("H:i"); ?>">
                      </div>
            ...
            <div class="box-body">
              ...
              <div class="col-md-12">
                 ...
                 <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="obj_ti" placeholder="Observaciones ..."></textarea>
                </div>            
                      </div> <!--// FIN DEL FORN-INLINE//-->
            ...
            <div class="box-body">
              ...
              <div class="col-md-12">
                 ...
                 <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="obser_ti" placeholder="Observaciones ..."></textarea>
                </div>            
                      </div> <!--// FIN DEL FORN-INLINE//-->
