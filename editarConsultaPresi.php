<?php 
  include("include/rol.php");
   ...
   $mostrar = "SELECT r.*, f.*, p.*, t.*, c.*, a.*, o.*, s.*, an.*, ap.*, n.* FROM residentes r INNER JOIN familiares f ON f.id_residente = r.id_residente INNER JOIN pareja p on p.id_residente = r.id_residente INNER JOIN tratamiento t on t.id_residente = r.id_residente INNER JOIN consultap c ON c.id_residente = r.id_residente INNER JOIN apoderado ap ON ap.id_residente = r.id_residente INNER JOIN antecedentes n ON n.id_residente = r.id_residente INNER JOIN area a ON a.id_consulta = c.id_consulta INNER JOIN objetivo o ON o.id_consulta = c.id_consulta INNER JOIN seguimiento s ON s.id_consulta = c.id_consulta INNER JOIN analisis an ON an.id_consulta = c.id_consulta WHERE r.id_residente = '$id_r' and c.id_consulta = '$id_con' ";  
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="ajax/consultaPsicologo/editarConsultaP.php?id=<?php echo $id_r; ?>&con=<?php echo $id_con; ?>" method="POST">
       <div class="container">
  <div class="row">
    <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="familiar" class="panel-collapse collapse in">
                        <div class="panel-body"> 
                            <div class="form-group">
                                <textarea type="text" name="familiar"  class="md-textarea form-control" rows="12"><?php echo $familiar; ?></textarea>
                            </div>                            
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="social" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <textarea type="text" name="social"  class="md-textarea form-control" rows="12"><?php echo $social; ?></textarea>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="laboral" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <textarea type="text" name="laboral" class="md-textarea form-control" rows="12"><?php echo $laboral; ?></textarea>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="academica" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <textarea type="text" name="academica" class="md-textarea form-control" rows="12"><?php echo $academica; ?></textarea>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="afectiva" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <textarea type="text" name="afectiva" class="md-textarea form-control" rows="12"><?php echo $afectiva; ?></textarea>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="conyugal" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <textarea type="text" name="conyugal"  class="md-textarea form-control" rows="12"><?php echo $conyugal; ?></textarea>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="objetivo-p" class="panel-collapse collapse in">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <textarea type="text" name="objetivo"  class="md-textarea form-control" rows="12"><?php echo $objetivo; ?></textarea>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="comportamiento" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <textarea type="text" name="apariencia" class="md-textarea form-control" rows="12"><?php echo $apariencia; ?></textarea>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="recomendacion" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <textarea type="text" name="recomendacion" class="md-textarea form-control" rows="12"><?php echo $recomendacion; ?></textarea>
                            </div>
        ...
        <div class="col-md-12">
            <div class="panel-group" id="accordion">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#objetivo-pd"><span class="">
                            </span> Antecedentes</a>
                        </h4>
                    </div>
                    <div id="objetivo-pd" class="panel-collapse collapse in">
                        <div class="panel-body">
                            
                            <div class="form-group">
                                <textarea type="text" name="antecedentes"  class="md-textarea form-control" rows="12"><?php echo $antecedentes; ?></textarea>
                            </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseT"><span class="">
                            </span> Conductas</a>
                        </h4>
                    </div>
                    <div id="collapseT" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <textarea type="text" name="conductas" class="md-textarea form-control" rows="12"><?php echo $conductas; ?></textarea>
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseTre" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <textarea type="text" name="consecuencia" class="md-textarea form-control" rows="12"><?php echo $consecuencia; ?></textarea>
                            </div>
              ...
              <div class="box-group" id="accordion">
                    ...
                    <div class="box-body">
                          <div class="form-group">
                            <label class="sr-only" for="ante_relevantes"></label>
                                <textarea type="text" name="ante_relevantes" id="" class="md-textarea form-control" rows="7"><?php echo $ante_relevantes; ?></textarea>
                            </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="box-body">
                             <div class="form-group">
                              <label class="sr-only" for="rela_familiares"></label>
                                <textarea type="text" name="rela_familiares" id="" class="md-textarea form-control" rows="7" ><?php echo $rela_familiares; ?></textarea>
                            </div> 
                    </div>
                  </div>
                </div>
                  ...
                  <div id="segSit" class="panel-collapse collapse">
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <textarea type="text" name="craving" id="" class="md-textarea form-control" rows="7" ><?php echo $craving; ?></textarea>
                      </div> 
                    </div>
                  </div>
                </div>
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        <label class="sr-only" for="rela_resi"></label>
                          <textarea type="text" name="rela_resi"  class="md-textarea form-control" rows="7" ><?php echo $rela_resi; ?></textarea>
                      </div> 
                    </div>
                  </div>
                </div>
                <div class="panel box box-solid">
                  ...
                  <div id="segCo" class="panel-collapse collapse">
                    <div class="box-body">
                      <div class="form-group">
                        <label class="sr-only" for="comen_session"></label>
                          <textarea type="text" name="comen_session"  class="md-textarea form-control" rows="7" ><?php echo $comen_session; ?></textarea>
                      </div> 
                    </div>
                  </div>
                </div>
