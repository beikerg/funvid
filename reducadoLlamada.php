<?php
 ...
 include("include/rol.php");
      ...
      if(isset($_GET["r"]) && $_GET["r"] != "registrado") {
...
<?php
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        --------------------------><br>
         <?php
      if(isset($_GET["r"])) {
        echo "<center><p class='alert alert-success alert-dismissible'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><strong>¡Bien Hecho!</strong> La llamada se ha agregado con éxito.</p></center>";
        ?>
  ...
  <form action="ajax/reducado/addLlamadaReducado.php" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" name="fecha_l"  value="<?php echo $f; ?>">
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
            ...
            <div class="tab-content">
                ...
                <div class="box box-solid">
                  <div class="box-body">
                    <div clas="form-group col-md-12">
                      <textarea type="text" name="familiar"  class="md-textarea form-control" rows="7"></textarea>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="tab-pane" id="soci">
                <div class="box box-solid">
                  <div class="box-body">
                    <div clas="form-group col-md-12">
                      <textarea type="text" name="social"  class="md-textarea form-control" rows="7"></textarea>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="tab-pane" id="lab">
                <div class="box box-solid">
                  <div class="box-body">
                    <div clas="form-group col-md-12">
                      <textarea type="text" name="laboral"  class="md-textarea form-control" rows="7"></textarea>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="tab-pane" id="aca">
                <div class="box box-solid">
                  <div class="box-body">
                    <div clas="form-group col-md-12">
                      <textarea type="text" name="academica"  class="md-textarea form-control" rows="7"></textarea>
                    </div>
                  </div>
                </div> 
              </div>
              ...
              <div class="tab-pane" id="afe">
                <div class="box box-solid">
                  <div class="box-body">
                    <div clas="form-group col-md-12">
                      <textarea type="text" name="afectiva" class="md-textarea form-control" rows="7"></textarea>
                    </div>
                  </div>
                </div> 
              </div>
              ...
              <div class="tab-pane" id="conyu">
                <div class="box box-solid">
                  <div class="box-body">
                    <div clas="form-group col-md-12">
                      <textarea type="text" name="conyugal"  class="md-textarea form-control" rows="7"></textarea>
                    </div>
                  </div>
                </div>
              </div>
