<?php
    ...
    if ($resultado->num_rows >0) {
        ...
        while ($fila = $resultado->fetch_assoc()) {
            $salida.="
                <div class='box-body box-solid table-responsive no-padding'>
            <tr>
                        ...
                        <td><a href='terapiaconfrontacion.php?id=".$fila['id_residente']."' class='btn btn-primary'><i class='glyphicon glyphicon-check'></i></a>
                        </td>
                    </tr>
                   </div> 
                    ";
