     ...
     <!--  <div class="row"> -->
        ...
        <table id="" class="display table table-bordered table-striped dt-responsive nowrap">
          ...
          <tbody>
            <?php
              include('ajax/db_connection.php');
              $sql = "SELECT r.nombre, r.apellido, i.* FROM residentes r INNER JOIN introvisacion i ON i.id_residente = r.id_residente WHERE i.estado_intro = '2' ORDER BY i.fecha_intro DESC";
              ...
              while($row = $query->fetch_assoc()){
                ...
                }elseif($row['estado_intro'] == '2'){
                  echo "<td><span class='label label-default'>Transferido</span></td>";
                }elseif($row['estado_intro'] == '0'){
