    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        <div class="form-group pull-right">
         ...
         <form action="ajax/terapias/RelatoPase/addRetaloPase.php" method="POST">  

          <?php include("ajax/terapias/RelatoPase/tableTResidente.php"); ?> 
          <!-- // INICIO BOX // -->
                     ...
                     <div class="row">
                      <div class="form-group col-md-4">
                         <label>Nombre Lider:</label><br>
                          <input class="form-control" type="text" name="nombre_lider"  placeholder="Nombre Lider">
                      </div>                      
                      <div class="form-group col-md-4">                          
                              <label>Nombre Colider:</label><br>
                              <input class="form-control" type="text"  name="nombre_colider" placeholder="Nombre Colider">
                      </div>                                        
                      <div class="form-group col-md-4">
                          <label>Nombre Director: </label><br>
                          <input class="form-control" type="text" name="nombre_director" placeholder="Nombre Director">
                      </div>                    
                      </div> <!-- / fin del row -->                     
                    <div class="row">                      
                      <div class="form-group col-md-4">
                        ...
                        <input type="date" value="<?php echo date("Y-m-d"); ?>" name="fecha_t" class="form-control pull-right" >
                      </div>
                      <!-- /.input group -->
                    </div>                     
                      <div class="form-group col-md-4">
                          <label>Hora inicio:</label><br>
                          <input class="form-control" type="time" name="h_inicio" value="<?php echo date("H:i"); ?>">
                      </div>
                      
                      <div class="form-group col-md-4">
                          <label>Hora termino:</label><br>
                          <input class="form-control" type="time" name="h_fin" value="<?php date("H:i"); ?>">
                      </div>
            ...
            <div class="box-body">
              ...
              <div class="col-md-12">
                 ...
                 <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="experiencia_r" placeholder="Observaciones ..."></textarea>
                </div>            
                      </div> <!--// FIN DEL FORN-INLINE//-->
          ...
          <div class="box box-default collapsed-box box-solid">
            ...
            <div class="box-body">
              ...
              <div class="row">
                  ...
                  <textarea class="form-control" rows="3" name="o_lider" placeholder="Observaciones ..."></textarea>
                </div>
                    
                    <div class="form-group col-md-12">
                  <label>Observaciones Colider</label>
                  <textarea class="form-control" rows="3" name="o_colider" placeholder="Observaciones ..."></textarea>
                </div>
                     
                    <div class="form-group col-md-12">
                  <label>Observaciones Director</label>
                  <textarea class="form-control" rows="3" name="o_director" placeholder="Observaciones ..."></textarea>
                </div>                  
              </div> <!--// FIN DEL FORN-INLINE//-->
