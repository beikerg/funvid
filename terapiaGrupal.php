  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Terapia Grupal</li>
      </ol>
    </section>
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        <div class="form-group pull-right">
         ...
         <form action="ajax/terapias/grupal/addGrupal.php" method="POST"> 

         <?php include("ajax/terapias/grupal/tableTResidente.php"); ?>  
          <!-- // INICIO BOX // -->
                     ...
                     <div class="row">
                      <div class="form-group col-md-4">
                         <label>Nombre Lider:</label><br>
                          <input class="form-control" type="text" name="lider_tg"  placeholder="Nombre Lider">
                      </div>                      
                      <div class="form-group col-md-4">                          
                              <label>Nombre Colider:</label><br>
                              <input class="form-control" type="text"  name="colider_tg" placeholder="Nombre Colider">
                      </div>                                        
                      <div class="form-group col-md-4">
                          <label>Nombre Director: </label><br>
                          <input class="form-control" type="text" name="director_tg" placeholder="Nombre Director">
                      </div>                    
                      </div> <!-- / fin del row -->                     
                    <div class="row">                      
                      <div class="form-group col-md-4">
                        ...
                        <input type="date" value="<?php echo date("Y-m-d"); ?>" name="fecha_tg" class="form-control pull-right" >
                      </div>
                      <!-- /.input group -->
                    </div>                     
                      <div class="form-group col-md-4">
                          <label>Hora inicio:</label><br>
                          <input class="form-control" type="time" name="h_inicio_tg" value="<?php echo date("H:i"); ?>">
                      </div>
                      
                      <div class="form-group col-md-4">
                          <label>Hora termino:</label><br>
                          <input class="form-control" type="time" name="h_fin_tg" value="<?php date("H:i"); ?>">
                      </div>
            ...
            <div class="box-body">
              ...
              <div class="col-md-12">
                 ...
                 <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="expo_tg" placeholder="Observaciones ..."></textarea>
                </div>            
                      </div> <!--// FIN DEL FORN-INLINE//-->
            ...
            <div class="box-body">
              ...
              <div class="col-md-12">
                 ...
                 <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="actitud_tg" placeholder="Observaciones ..."></textarea>
                </div>            
                      </div> <!--// FIN DEL FORN-INLINE//-->
          ...
          <div class="box box-default collapsed-box box-solid">
            ...
            <div class="box-body">
              ...
              <div class="row">
                  ...
                  <textarea class="form-control" rows="3" name="o_lider_tg" placeholder="Observaciones ..."></textarea>
                </div>
                    
                    <div class="form-group col-md-12">
                  <label>Observaciones Colider</label>
                  <textarea class="form-control" rows="3" name="o_colider_tg" placeholder="Observaciones ..."></textarea>
                </div>
                     
                    <div class="form-group col-md-12">
                  <label>Observaciones Director</label>
                  <textarea class="form-control" rows="3" name="o_director_tg" placeholder="Observaciones ..."></textarea>
                </div>                  
              </div> <!--// FIN DEL FORN-INLINE//-->
